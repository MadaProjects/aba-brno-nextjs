  ...
  return (
    <div className=' shadow-md dark:shadow-none ' data-testid='header'>
      <div className='container mx-auto'>
        <nav className='container flex flex-nowrap items-center justify-between mx-auto bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-slate-900'>
          ...
          <div
            className={`hidden items-center justify-between w-full md:flex md:w-auto md:order-1 md:ml-auto`}
            id='navbar-default'>
      ...
      <div
        className={`${
          openMenu ? `` : `hidden`
        } md:hidden items-center justify-between w-full md:flex md:w-auto md:order-1 md:ml-auto`}
        id='navbar-default'>
            ...
            return (
              <li key={i}>
                <Link
                  href={`../${menu.main_page.data.attributes.Url}`}
                  className={
                    router.asPath === `./${menu.main_page.data.attributes.Url}`
                      ? activeClassName
                      : nonActiveClassName
                  }
                  aria-current='page'>
