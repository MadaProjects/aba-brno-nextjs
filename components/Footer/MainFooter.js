...
export const MainFooter = ({ footerMenu, setting }) => {
      ...
      <footer className='p-4 bg-white sm:p-6 dark:bg-slate-900'>
        <div className='md:flex md:justify-between'>
          ...
          <div className='grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 md:pl-10'>
            {footerMenu.Menu.map((menuColumn, i) => (
        ...
        <div className='flex flex-col-reverse md:flex-row sm:items-center sm:justify-between'>
          <div className='flex flex-col mt-6 md:mt-0'>
            <span className='text-center text-sm md:text-left text-gray-500 sm:text-center dark:text-gray-400'>
              © {currentYear}{' '}
              <a
          ...
          <div className='flex space-x-6 justify-center sm:mt-0'>
            {setting &&
              setting.social_media_sites.data.map((socialMedia, i) => {
                let socialMediaIcon = (
                  <svg
                    className='w-5 h-5'
                    fill='currentColor'
